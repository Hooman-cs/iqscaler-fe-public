...
// --- OPTIMIZATION: STATIC DATA MOVED OUTSIDE COMPONENT ---
...
const famousPersonalities = [
    { image: albertEinsteinImage, name: 'Albert Einstein', title: 'Theoretical Physicist', iq: 162 },
    { image: marieCurieImage, name: 'Marie Curie', title: 'Pioneering Physicist & Chemist', iq: 177 },
    { image: nikolaTeslaImage, name: 'Nikola Tesla', title: 'Inventor & Electrical Engineer', iq: 160 },
    { image: stephenHawkingImage, name: 'Stephen Hawking', title: 'Theoretical Physicist & Cosmologist', iq: 158 },
    { image: billGatesImage, name: 'Bill Gates', title: 'Co-founder of Microsoft', iq: 153 },
    { image: sundarPichaiImage, name: 'Sundar Pichai', title: 'CEO of Google & Alphabet', iq: 148 },
    { image: satyaNadellaImage, name: 'Satya Nadella', title: 'CEO of Microsoft', iq: 149 },
    { image: markZuckerbergImage, name: 'Mark Zuckerberg', title: 'CEO of Meta Platforms', iq: 152 },
    { image: steveJobsImage, name: 'Steve Jobs', title: 'Co-founder of Apple Inc.', iq: 158 },
    { image: masayoshiSonImage, name: 'Masayoshi Son', title: 'Founder & CEO of SoftBank', iq: 143 },
    { image: hiroshiMikitaniImage, name: 'Hiroshi Mikitani', title: 'Founder & CEO of Rakuten', iq: 135 },
    { image: vijayShekharSharmaImage, name: 'Vijay Shekhar Sharma', title: 'Founder & CEO of Paytm', iq: 135 },
    { image: kazuoHiraiImage, name: 'Kazuo Hirai', title: 'Former CEO of Sony', iq: 133 },
];
...
const HomeScreen = () => {
    ...
    return (
        <div className="overflow-x-hidden"> 
            ...
            >
                ...
                <div className="max-w-4xl p-4 md:p-8 z-10">
                    ...
                    <p className="text-lg md:text-2xl text-gray-200 mb-10 max-w-3xl mx-auto drop-shadow-md">
                        Our advanced IQ Scaler platform delivers accurate, research-based insights into your reasoning, memory, and analytical thinking.
                    </p>
            ...
            {/* 4. Global IQ Distribution Section - LAZY LOADING ADDED */}
                ...
                <div className="max-w-6xl mx-auto text-center">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-10 bg-gray-50 p-6 md:p-12 rounded-3xl shadow-sm">
                        <div className="w-full lg:w-1/2"> 
                            ...
                            <img src={iqDonutChartImage} loading="lazy" alt="IQ Distribution" className="w-full h-auto rounded-xl shadow-lg" />
                        </div>
            ...
            {/* 5. IQ Trends Section - LAZY LOADING ADDED */}
                ...
                <div className="max-w-6xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12">
                        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md border-t-4 border-purple-500">
                            ...
                            <img src={iqByAgeImage} loading="lazy" alt="Age Trends" className="w-full h-auto mb-6 rounded-lg" />
                        ...
                        <div className="bg-white p-6 md:p-8 rounded-2xl shadow-md border-t-4 border-pink-500">
                            ...
                            <img src={iqByEducationImage} loading="lazy" alt="Education Trends" className="w-full h-auto mb-6 rounded-lg" />
            ...
            {/* 6. IQ by Country Section - LAZY LOADING ADDED */}
            ...
            {/* 7. Famous Personalities - LAZY LOADING ADDED */}
